...
$image_prop         = codexin_attachment_metas_extended( $post->ID, 'blog', ( $post_style == 'grid' && ! is_singular() && ! is_search() ) ? 'codexin-core-rectangle-one' : 'codexin-framework-rectangle-two' );

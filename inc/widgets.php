...
/*
	============================================
		REVEAL TWITTER WIDGET CLASS
	============================================
*/


class Reveal_Twitter_Widget extends WP_Widget {
	
	//setup the widget name, description, etc...
	public function __construct() {
		
		$widget_ops = array(
			'classname' => 'reveal-twitter-widget',
			'description' => esc_html('Displays Most Recent Tweets' , 'reveal'),
		);
		parent::__construct( 'reveal_twitter_widget', esc_html__('Reveal: Twitter Widget', 'reveal'), $widget_ops );
...
add_action( 'widgets_init', function() {
	register_widget( 'Reveal_Twitter_Widget' );
} );